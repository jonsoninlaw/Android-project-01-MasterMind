...
public class EasyGameActivity extends AppCompatActivity {
    ...
    private void destination(TextView[] playerGuess, String number) {
        if (playerGuess[0].getText().toString().length() != 0
                && playerGuess[1].getText().toString().length() != 0
                && playerGuess[2].getText().toString().length() != 0
                && playerGuess[3].getText().toString().length() != 0
                && playerGuess[4].getText().toString().length() != 0) {
            if (!playerGuess[0].getText().toString().equals(Integer.toString(master.getMastermind()[0]))) {
                playerGuess[0].setText("");
            }
            if (!playerGuess[1].getText().toString().equals(Integer.toString(master.getMastermind()[1]))) {
                playerGuess[1].setText("");
            }
            if (!playerGuess[2].getText().toString().equals(Integer.toString(master.getMastermind()[2]))) {
                playerGuess[2].setText("");
            }
            if (!playerGuess[3].getText().toString().equals(Integer.toString(master.getMastermind()[3]))) {
                playerGuess[3].setText("");
            }
            if (!playerGuess[4].getText().toString().equals(Integer.toString(master.getMastermind()[4]))) {
